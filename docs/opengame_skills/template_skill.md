...
> Source copy from `leigest519/OpenGame` at commit `c54307efe1dab927e7fc52dbb92af6b3df1d1c66`, file `agent-test/template-skill/README.md`.
> OpenGame is Apache-2.0 licensed; see `OPENGAME_LICENSE` in this directory.
> Relative links in this copied document refer to the original OpenGame repository layout.
