...
- learner sentence corpus covers practiced item-room microscope vocabulary explanation requests after leaving the source room through AI-backed vocabulary explanation
- learner sentence corpus covers indirect practiced item-room microscope vocabulary explanation requests routed through validated AI interpretation after leaving the source room through AI-backed vocabulary explanation
...
- learner sentence corpus covers practiced item-room strain vocabulary explanation requests after leaving the source room through AI-backed vocabulary explanation
...
- learner sentence corpus covers indirect item-room visible bacteria vocabulary explanation requests routed through validated AI interpretation before practice without changing inventory, quest, mastery, XP, HP, or room state
- learner sentence corpus covers item-room visible strain vocabulary explanation requests before practice without changing inventory, quest, mastery, XP, HP, or room state
- learner sentence corpus covers indirect item-room visible strain vocabulary explanation requests routed through validated AI interpretation before practice without changing inventory, quest, mastery, XP, HP, or room state
- learner sentence corpus covers vaccine-bench visible vaccine vocabulary explanation requests before practice without changing inventory, quest, mastery, XP, HP, or room state
...
- learner sentence corpus covers indirect start-room visible organism vocabulary explanation requests routed through validated AI interpretation before movement or practice
- learner sentence corpus covers start-room visible species vocabulary explanation requests before movement or practice
...
- learner sentence corpus covers indirect practiced start-room organism vocabulary explanation requests routed through validated AI interpretation after movement through AI-backed vocabulary explanation
...
- learner sentence corpus covers practiced start-room species vocabulary explanation requests after movement through AI-backed vocabulary explanation
- learner sentence corpus covers indirect practiced start-room species vocabulary explanation requests routed through validated AI interpretation after movement through AI-backed vocabulary explanation
...
- learner sentence corpus covers indirect start-room encountered-only evolve vocabulary explanation requests routed through validated AI interpretation and rejected after movement before AI vocabulary calls
- learner sentence corpus covers practiced start-room evolve vocabulary explanation requests after movement through AI-backed vocabulary explanation
- learner sentence corpus covers indirect practiced start-room evolve vocabulary explanation requests routed through validated AI interpretation after movement through AI-backed vocabulary explanation
...
- practice-schedule-only review answers such as saying `fungus` belongs in a TOEFL practice schedule now reach validated AI evaluation, remain rejected, keep the review active, and award no XP
- word-bank-only review answers such as saying `fungus` belongs in a TOEFL word bank now reach validated AI evaluation, remain rejected, keep the review active, and award no XP
- glossary-only review answers such as saying `fungus` belongs in a TOEFL glossary now reach validated AI evaluation, remain rejected, keep the review active, and award no XP
- synonym-list-only review answers such as saying `fungus` belongs in a TOEFL synonym list now reach validated AI evaluation, remain rejected, keep the review active, and award no XP
- mnemonic-only review answers such as saying `fungus` helps a TOEFL mnemonic now reach validated AI evaluation, remain rejected, keep the review active, and award no XP
- spelling-bee-only review answers such as saying `fungus` belongs in TOEFL spelling bee practice now reach validated AI evaluation, remain rejected, keep the review active, and award no XP
- crossword-only review answers such as saying `fungus` belongs in a TOEFL crossword now reach validated AI evaluation, remain rejected, keep the review active, and award no XP
- word-search-only review answers such as saying `fungus` belongs in a TOEFL word search now reach validated AI evaluation, remain rejected, keep the review active, and award no XP
- hangman-only review answers such as saying `fungus` belongs in a TOEFL hangman game now reach validated AI evaluation, remain rejected, keep the review active, and award no XP
...
### T-289 — Add review answer corpus case for synonym-list-only target use

- **State:** done
- **Priority:** P2
- **Goal:** Protect review feedback when a learner says the active word belongs in a synonym list but does not show its Biology meaning, role, property, or consequence.
- **Acceptance criteria:**
  - review corpus includes at least one synonym-list-only sentence containing the active review word
  - expected AI evaluation result and deterministic XP/review outcome are explicit
  - no live Codex CLI is required
- **Verification:** learner sentence corpus tests and full suite.
- **Dependencies:** T-288.

### T-290 — Add review answer corpus case for mnemonic-only target use

- **State:** done
- **Priority:** P2
- **Goal:** Protect review feedback when a learner says the active word helps a mnemonic but does not show its Biology meaning, role, property, or consequence.
- **Acceptance criteria:**
  - review corpus includes at least one mnemonic-only sentence containing the active review word
  - expected AI evaluation result and deterministic XP/review outcome are explicit
  - no live Codex CLI is required
- **Verification:** learner sentence corpus tests and full suite.
- **Dependencies:** T-289.

### T-291 — Add review answer corpus case for spelling-bee-only target use

- **State:** done
- **Priority:** P2
- **Goal:** Protect review feedback when a learner says the active word belongs in a spelling bee but does not show its Biology meaning, role, property, or consequence.
- **Acceptance criteria:**
  - review corpus includes at least one spelling-bee-only sentence containing the active review word
  - expected AI evaluation result and deterministic XP/review outcome are explicit
  - no live Codex CLI is required
- **Verification:** learner sentence corpus tests and full suite.
- **Dependencies:** T-290.

### T-292 — Add review answer corpus case for crossword-only target use

- **State:** done
- **Priority:** P2
- **Goal:** Protect review feedback when a learner says the active word belongs in a crossword but does not show its Biology meaning, role, property, or consequence.
- **Acceptance criteria:**
  - review corpus includes at least one crossword-only sentence containing the active review word
  - expected AI evaluation result and deterministic XP/review outcome are explicit
  - no live Codex CLI is required
- **Verification:** learner sentence corpus tests and full suite.
- **Dependencies:** T-291.

### T-293 — Add review answer corpus case for word-search-only target use

- **State:** done
- **Priority:** P2
- **Goal:** Protect review feedback when a learner says the active word belongs in a word search but does not show its Biology meaning, role, property, or consequence.
- **Acceptance criteria:**
  - review corpus includes at least one word-search-only sentence containing the active review word
  - expected AI evaluation result and deterministic XP/review outcome are explicit
  - no live Codex CLI is required
- **Verification:** learner sentence corpus tests and full suite.
- **Dependencies:** T-292.

### T-294 — Add review answer corpus case for hangman-only target use

- **State:** done
- **Priority:** P2
- **Goal:** Protect review feedback when a learner says the active word belongs in a hangman game but does not show its Biology meaning, role, property, or consequence.
- **Acceptance criteria:**
  - review corpus includes at least one hangman-only sentence containing the active review word
  - expected AI evaluation result and deterministic XP/review outcome are explicit
  - no live Codex CLI is required
- **Verification:** learner sentence corpus tests and full suite.
- **Dependencies:** T-293.

### T-295 — Add review answer corpus case for vocabulary-game-only target use

- **State:** done
- **Priority:** P2
- **Goal:** Protect review feedback when a learner says the active word belongs in a vocabulary game but does not show its Biology meaning, role, property, or consequence.
- **Acceptance criteria:**
  - review corpus includes at least one vocabulary-game-only sentence containing the active review word
  - expected AI evaluation result and deterministic XP/review outcome are explicit
  - no live Codex CLI is required
- **Verification:** learner sentence corpus tests and full suite.
- **Dependencies:** T-294.

### T-296 — Add review answer corpus case for word-puzzle-only target use

- **State:** done
- **Priority:** P2
- **Goal:** Protect review feedback when a learner says the active word belongs in a word puzzle but does not show its Biology meaning, role, property, or consequence.
- **Acceptance criteria:**
  - review corpus includes at least one word-puzzle-only sentence containing the active review word
  - expected AI evaluation result and deterministic XP/review outcome are explicit
  - no live Codex CLI is required
- **Verification:** learner sentence corpus tests and full suite.
- **Dependencies:** T-295.

### T-297 — Add review answer corpus case for vocabulary-app-only target use

- **State:** done
- **Priority:** P2
- **Goal:** Protect review feedback when a learner says the active word belongs in a vocabulary app but does not show its Biology meaning, role, property, or consequence.
- **Acceptance criteria:**
  - review corpus includes at least one vocabulary-app-only sentence containing the active review word
  - expected AI evaluation result and deterministic XP/review outcome are explicit
  - no live Codex CLI is required
- **Verification:** learner sentence corpus tests and full suite.
- **Dependencies:** T-296.
...
### T-300 — Add review answer corpus case for learning-platform-only target use

- **State:** done
- **Priority:** P2
- **Goal:** Protect review feedback when a learner says the active word belongs on a TOEFL learning platform but does not show its Biology meaning, role, property, or consequence.
- **Acceptance criteria:**
  - review corpus includes at least one learning-platform-only sentence containing the active review word
  - expected AI evaluation result and deterministic XP/review outcome are explicit
  - no live Codex CLI is required
- **Verification:** learner sentence corpus tests and full suite.
- **Dependencies:** T-299.
...
- **Acceptance criteria:**
  - review corpus includes at least one e-learning-only sentence containing the active review word
  - expected AI evaluation result and deterministic XP/review outcome are explicit
  - no live Codex CLI is required
- **Verification:** learner sentence corpus tests and full suite.
- **Dependencies:** T-300.
...
- **Acceptance criteria:**
  - playtest debug protocol includes a save-path churn entry
  - entry identifies deterministic save ownership, AI non-authority over save paths, verified fix, and smoke-test coverage
  - no OpenGame runtime dependency, Node tooling, browser-game scaffold, asset pipeline, or new API-key requirement is introduced
- **Verification:** documentation consistency check.
- **Dependencies:** T-303.
...
- **Acceptance criteria:**
  - playtest debug protocol includes a renderer-output ambiguity entry
  - entry identifies deterministic renderer ownership, AI display-only boundary, verified fix, and renderer-test coverage
  - no OpenGame runtime dependency, Node tooling, browser-game scaffold, asset pipeline, or new API-key requirement is introduced
- **Verification:** documentation consistency check.
- **Dependencies:** T-305.
...
### T-309 — Add learner sentence corpus case for unknown vocabulary explanation requests

- **State:** done
- **Priority:** P2
- **Goal:** Cover a full-sentence learner request that asks for an explanation of a word outside the Biology world vocabulary.
- **Acceptance criteria:**
  - learner sentence corpus includes an unknown-word explanation request
  - case preserves deterministic state and gives a clear non-vocabulary result
  - AI does not invent or authorize explanations for words outside the world vocabulary
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-308.
...
- **Acceptance criteria:**
  - learner sentence corpus includes a practiced-word explanation request outside the word's source room
  - case routes to the `explain` action and succeeds through AI-backed vocabulary explanation
...
### T-314 — Add indirect item-practiced explanation away from source room

- **State:** done
- **Priority:** P2
- **Goal:** Cover an indirect full-sentence learner request for an item-practiced Biology word after leaving the source room.
- **Acceptance criteria:**
  - learner sentence corpus includes an indirect item-practiced explanation request away from the source room
  - case routes through validated AI interpretation to deterministic `explain`
  - AI-backed vocabulary explanation succeeds while inventory, quest, mastery, and room state remain unchanged during explanation
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-313.
...
- **Acceptance criteria:**
  - learner sentence corpus includes a combat-practiced Biology word requested from another room
  - case routes to `explain` and succeeds through AI-backed vocabulary explanation
...
### T-317 — Add combat-room encountered-only explanation rejection

- **State:** done
- **Priority:** P2
- **Goal:** Prove that merely visiting the combat room does not authorize off-room vocabulary explanation access for combat words.
- **Acceptance criteria:**
  - learner sentence corpus includes a combat-room word encountered by visiting the Mimicry Trail, then requested from another room before defeating the enemy
  - case rejects before AI vocabulary explanation and keeps combat, mastery, and room state unchanged
  - message distinguishes encountered-only access from visible or practiced vocabulary access
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-316.
...
- **Acceptance criteria:**
  - learner sentence corpus includes an indirect combat-room encountered-only explanation request away from the source room
  - case routes through validated AI interpretation to deterministic `explain`
...
### T-320 — Add indirect combat-room visible explanation before combat

- **State:** done
- **Priority:** P2
- **Goal:** Cover an indirect full-sentence request for combat-room vocabulary while the player is still in its source room before combat practice.
- **Acceptance criteria:**
  - learner sentence corpus includes an indirect combat-room visible explanation request before defeating the enemy
  - case routes through validated AI interpretation to deterministic `explain`
  - AI-backed vocabulary explanation succeeds without mutating combat, mastery, quest, XP, or room state
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-319.

### T-321 — Add item-room visible explanation before item use

- **State:** done
- **Priority:** P2
- **Goal:** Prove item-room vocabulary is explainable while the player is in the source room before using the related item.
- **Acceptance criteria:**
  - learner sentence corpus includes a direct microscope vocabulary explanation request while standing in the Microscope Tent before using the microscope
  - case routes to deterministic `explain` and succeeds through AI-backed vocabulary explanation
  - explanation does not mutate inventory, quest, mastery, XP, or room state
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-320.
...
- **Acceptance criteria:**
  - learner sentence corpus includes an indirect microscope vocabulary explanation request while standing in the Microscope Tent before using the microscope
  - case routes through validated AI interpretation to deterministic `explain`
  - AI-backed vocabulary explanation succeeds without mutating inventory, quest, mastery, XP, or room state
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-321.
...
- **Acceptance criteria:**
  - learner sentence corpus includes a fungus vocabulary explanation request while standing in the Fungus Grove before collecting the sample
  - case routes to deterministic `explain` and succeeds through AI-backed vocabulary explanation
  - explanation does not mutate inventory, quest, mastery, XP, or room state
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-322.

### T-324 — Add indirect source-room visible fungus explanation before collection

- **State:** done
- **Priority:** P2
- **Goal:** Cover an indirect full-sentence request for fungus vocabulary while the player is in Fungus Grove before collection or sentence practice.
- **Acceptance criteria:**
  - learner sentence corpus includes an indirect fungus vocabulary explanation request while standing in Fungus Grove before collecting the sample
  - case routes through validated AI interpretation to deterministic `explain`
  - AI-backed vocabulary explanation succeeds without mutating inventory, quest, mastery, XP, or room state
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-323.
...
- **Acceptance criteria:**
  - learner sentence corpus includes a direct organism vocabulary explanation request from Research Camp
  - case routes to deterministic `explain` and succeeds through AI-backed vocabulary explanation
...
### T-329 — Add evolve visible explanation from Research Camp

- **State:** done
- **Priority:** P2
- **Goal:** Prove the remaining start-room Biology word remains explainable from visible room vocabulary before practice.
- **Acceptance criteria:**
  - learner sentence corpus includes a direct `evolve` explanation request from Research Camp
  - case routes to deterministic `explain` and succeeds through AI-backed vocabulary explanation
  - explanation does not mutate inventory, quest, mastery, XP, HP, or room state
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-328.

### T-330 — Add indirect evolve visible explanation

- **State:** done
- **Priority:** P2
- **Goal:** Prove indirect start-room `evolve` explanation requests route through AI interpretation without mutating state.
- **Acceptance criteria:**
  - learner sentence corpus includes an indirect `evolve` explanation request from Research Camp
  - case routes through AI interpretation to deterministic `explain`
  - explanation does not mutate inventory, quest, mastery, XP, HP, or room state
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-329.
...
- **Acceptance criteria:**
  - learner sentence corpus includes a direct `organism` explanation request after moving from Research Camp to Fungus Grove without practice
...
- **Acceptance criteria:**
  - learner sentence corpus includes an indirect `organism` explanation request after moving from Research Camp to Fungus Grove without practice
  - case routes through AI interpretation to deterministic `explain`
...
- **Acceptance criteria:**
  - learner sentence corpus includes a direct `evolve` explanation request after moving from Research Camp to Fungus Grove without practice
  - case routes to deterministic `explain` and is rejected before AI vocabulary explanation
  - rejection does not mutate inventory, quest, mastery, XP, HP, or room state
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-334.
...
- **Acceptance criteria:**
  - learner sentence corpus includes an indirect `evolve` explanation request after moving from Research Camp to Fungus Grove without practice
  - case routes through AI interpretation to deterministic `explain`
  - rejection happens before AI vocabulary explanation and does not mutate inventory, quest, mastery, XP, HP, or room state
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-335.
...
- **Acceptance criteria:**
  - learner sentence corpus includes a direct `organism` explanation request after practicing `organism` in Research Camp and moving to Fungus Grove
  - case routes to deterministic `explain` and succeeds through AI-backed vocabulary explanation
  - explanation does not mutate inventory, quest, mastery, XP, HP, or room state beyond the setup practice
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-336.
...
- **Acceptance criteria:**
  - learner sentence corpus includes an indirect `organism` explanation request after practicing `organism` in Research Camp and moving to Fungus Grove
  - case routes through AI interpretation to deterministic `explain`
...
### T-341 — Add practiced start-room evolve explanation after movement

- **State:** done
- **Priority:** P2
- **Goal:** Prove practiced start-room `evolve` remains explainable after leaving Research Camp.
- **Acceptance criteria:**
  - learner sentence corpus includes a direct `evolve` explanation request after practicing `evolve` in Research Camp and moving to Fungus Grove
  - case routes to deterministic `explain` and succeeds through AI-backed vocabulary explanation
  - explanation does not mutate inventory, quest, mastery, XP, HP, or room state beyond setup practice
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-340.

### T-342 — Add indirect practiced start-room evolve explanation after movement

- **State:** done
- **Priority:** P2
- **Goal:** Prove indirect practiced start-room evolve explanation requests away from Research Camp route through AI interpretation and succeed.
- **Acceptance criteria:**
  - learner sentence corpus includes an indirect `evolve` explanation request after practicing `evolve` in Research Camp and moving to Fungus Grove
  - case routes through AI interpretation to deterministic `explain`
  - explanation succeeds through AI-backed vocabulary explanation without mutating inventory, quest, mastery, XP, HP, or room state beyond setup practice
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-341.

### T-343 — Add practiced item-room microscope explanation after leaving source room

- **State:** done
- **Priority:** P2
- **Goal:** Prove practiced item-room vocabulary remains explainable after leaving its source room.
- **Acceptance criteria:**
  - learner sentence corpus includes a direct `microscope` explanation request after practicing `microscope` in Microscope Tent and returning to Research Camp
  - case routes to deterministic `explain` and succeeds through AI-backed vocabulary explanation
  - explanation does not mutate inventory, quest, mastery, XP, HP, or room state beyond setup practice
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-342.

### T-344 — Add indirect practiced item-room microscope explanation after leaving source room

- **State:** done
- **Priority:** P2
- **Goal:** Prove indirect practiced item-room vocabulary explanation requests away from the source room route through AI interpretation and succeed.
- **Acceptance criteria:**
  - learner sentence corpus includes an indirect `microscope` explanation request after practicing `microscope` in Microscope Tent and returning to Research Camp
  - case routes through AI interpretation to deterministic `explain`
  - explanation succeeds through AI-backed vocabulary explanation without mutating inventory, quest, mastery, XP, HP, or room state beyond setup practice
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-343.

### T-345 — Add item-room encountered-only bacteria rejection after leaving source room

- **State:** done
- **Priority:** P2
- **Goal:** Prove item-room target words are not explainable after leaving their source room unless practiced.
- **Acceptance criteria:**
  - learner sentence corpus includes a direct `bacteria` explanation request after entering Microscope Tent and returning to Research Camp without practice
  - case routes to deterministic `explain`
  - rejection happens before AI vocabulary explanation and does not mutate inventory, quest, mastery, XP, HP, or room state
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-344.

### T-346 — Add indirect item-room encountered-only bacteria rejection after leaving source room

- **State:** done
- **Priority:** P2
- **Goal:** Prove indirect item-room encountered-only explanation requests away from the source room route through AI interpretation but remain deterministically rejected.
- **Acceptance criteria:**
  - learner sentence corpus includes an indirect `bacteria` explanation request after entering Microscope Tent and returning to Research Camp without practice
  - case routes through AI interpretation to deterministic `explain`
  - rejection happens before AI vocabulary explanation and does not mutate inventory, quest, mastery, XP, HP, or room state
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-345.

### T-347 — Add item-room encountered-only strain rejection after leaving source room

- **State:** done
- **Priority:** P2
- **Goal:** Prove another item-room target word is not explainable after leaving its source room unless practiced.
- **Acceptance criteria:**
  - learner sentence corpus includes a direct `strain` explanation request after entering Microscope Tent and returning to Research Camp without practice
  - case routes to deterministic `explain`
  - rejection happens before AI vocabulary explanation and does not mutate inventory, quest, mastery, XP, HP, or room state
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-346.
...
- **Acceptance criteria:**
  - learner sentence corpus includes an indirect `strain` explanation request after entering Microscope Tent and returning to Research Camp without practice
  - case routes through AI interpretation to deterministic `explain`
  - rejection happens before AI vocabulary explanation and does not mutate inventory, quest, mastery, XP, HP, or room state
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-347.
...
- **Acceptance criteria:**
  - learner sentence corpus includes a direct `strain` explanation request after practicing `strain` in Microscope Tent and returning to Research Camp
  - case routes to deterministic `explain`
  - explanation succeeds through AI-backed vocabulary explanation without mutating inventory, quest, mastery, XP, HP, or room state beyond setup practice
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-348.
...
### T-351 — Add practiced item-room bacteria explanation after leaving source room

- **State:** done
- **Priority:** P2
- **Goal:** Prove practiced item-room bacteria vocabulary remains explainable after leaving the source room.
- **Acceptance criteria:**
  - learner sentence corpus includes a direct `bacteria` explanation request after practicing `bacteria` in Microscope Tent and returning to Research Camp
  - case routes to deterministic `explain`
  - explanation succeeds through AI-backed vocabulary explanation without mutating inventory, quest, mastery, XP, HP, or room state beyond setup practice
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-350.

### T-352 — Add indirect practiced item-room bacteria explanation after leaving source room

- **State:** done
- **Priority:** P2
- **Goal:** Prove indirect practiced item-room bacteria vocabulary requests route through AI interpretation and remain explainable after leaving the source room.
- **Acceptance criteria:**
  - learner sentence corpus includes an indirect `bacteria` explanation request after practicing `bacteria` in Microscope Tent and returning to Research Camp
  - case routes through AI interpretation to deterministic `explain`
  - explanation succeeds through AI-backed vocabulary explanation without mutating inventory, quest, mastery, XP, HP, or room state beyond setup practice
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-351.
...
- **Acceptance criteria:**
  - learner sentence corpus includes a direct `bacteria` explanation request in Microscope Tent before practice
  - case routes to deterministic `explain`
...
- **Acceptance criteria:**
  - learner sentence corpus includes an indirect `bacteria` explanation request in Microscope Tent before practice
  - case routes through AI interpretation to deterministic `explain`
  - explanation succeeds through AI-backed vocabulary explanation without mutating inventory, quest, mastery, XP, HP, or room state
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-353.
...
### T-356 — Add indirect item-room visible strain explanation before practice

- **State:** done
- **Priority:** P2
- **Goal:** Prove indirect visible item-room strain vocabulary requests route through AI interpretation and remain explainable in Microscope Tent before practice.
- **Acceptance criteria:**
  - learner sentence corpus includes an indirect `strain` explanation request in Microscope Tent before practice
  - case routes through AI interpretation to deterministic `explain`
  - explanation succeeds through AI-backed vocabulary explanation without mutating inventory, quest, mastery, XP, HP, or room state
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-355.

### T-357 — Add vaccine-bench visible vaccine explanation before practice

- **State:** done
- **Priority:** P2
- **Goal:** Prove visible vaccine-bench vocabulary can be explained at the Vaccine Bench before practice while preserving deterministic state.
- **Acceptance criteria:**
  - learner sentence corpus includes a direct `vaccine` explanation request at Vaccine Bench before practice
  - case routes to deterministic `explain`
  - explanation succeeds through AI-backed vocabulary explanation without mutating inventory, quest, mastery, XP, HP, or room state
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-356.

### T-358 — Add indirect vaccine-bench visible vaccine explanation before practice

- **State:** done
- **Priority:** P2
- **Goal:** Prove indirect visible vaccine-bench vocabulary requests route through AI interpretation and remain explainable at Vaccine Bench before practice.
- **Acceptance criteria:**
  - learner sentence corpus includes an indirect `vaccine` explanation request at Vaccine Bench before practice
  - case routes through AI interpretation to deterministic `explain`
  - explanation succeeds through AI-backed vocabulary explanation without mutating inventory, quest, mastery, XP, HP, or room state
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-357.

### T-359 — Add vaccine-bench visible immune explanation before practice

- **State:** done
- **Priority:** P2
- **Goal:** Prove visible vaccine-bench `immune` vocabulary can be explained at the Vaccine Bench before practice while preserving deterministic state.
- **Acceptance criteria:**
  - learner sentence corpus includes a direct `immune` explanation request at Vaccine Bench before practice
  - case routes to deterministic `explain`
  - explanation succeeds through AI-backed vocabulary explanation without mutating inventory, quest, mastery, XP, HP, or room state
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-358.

### T-360 — Add indirect vaccine-bench visible immune explanation before practice

- **State:** ready
- **Priority:** P2
- **Goal:** Prove indirect visible vaccine-bench `immune` vocabulary requests route through AI interpretation and remain explainable at Vaccine Bench before practice.
- **Acceptance criteria:**
  - learner sentence corpus includes an indirect `immune` explanation request at Vaccine Bench before practice
  - case routes through AI interpretation to deterministic `explain`
  - explanation succeeds through AI-backed vocabulary explanation without mutating inventory, quest, mastery, XP, HP, or room state
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-359.
...
- **Acceptance criteria:**
  - learner sentence corpus includes a direct `respiration` explanation request at Vaccine Bench before practice
  - case routes to deterministic `explain`
  - explanation succeeds through AI-backed vocabulary explanation without mutating inventory, quest, mastery, XP, HP, or room state
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-360.
...
- **Acceptance criteria:**
  - learner sentence corpus includes an indirect `respiration` explanation request at Vaccine Bench before practice
  - case routes through AI interpretation to deterministic `explain`
  - explanation succeeds through AI-backed vocabulary explanation without mutating inventory, quest, mastery, XP, HP, or room state
- **Verification:** learner sentence corpus tests.
- **Dependencies:** T-361.
...
- 2026-06-24: Completed T-357 by adding a direct `Could you define vaccine?` corpus case at Vaccine Bench before practice, proving visible vaccine-bench vocabulary can be explained through AI-backed vocabulary explanation without inventory, quest, mastery, XP, HP, or room mutation.
- 2026-06-24: Completed T-356 by adding an indirect `What does strain mean while I am in this tent?` corpus case in Microscope Tent before practice, proving validated AI interpretation reaches deterministic `explain` and succeeds through AI-backed vocabulary explanation without inventory, quest, mastery, XP, HP, or room mutation.
- 2026-06-24: Completed T-355 by adding a direct `Could you define strain?` corpus case in Microscope Tent before practice, proving visible item-room vocabulary can be explained through AI-backed vocabulary explanation without inventory, quest, mastery, XP, HP, or room mutation.
- 2026-06-24: Completed T-354 by adding an indirect `What does bacteria mean while I am in this tent?` corpus case in Microscope Tent before practice, proving validated AI interpretation reaches deterministic `explain` and succeeds through AI-backed vocabulary explanation without inventory, quest, mastery, XP, HP, or room mutation.
